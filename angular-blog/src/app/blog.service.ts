...
export class BlogService {
  ...
  fetchPosts(username: string): Promise<Post[]> {
    return new Promise<Post[]>((resolve, reject) => {
      this.http.get<Post[]>(`/api/posts?username=${username}`)
        .toPromise()
        .then((res) => {
          res.sort((x, y) => {
  ...
  getPost(username: string, postid: number): Promise<Post> {
    return new Promise<Post>((resolve, reject) => {
      this.http.get<Post>(`/api/posts?username=${username}&postid=${postid}`)
        .toPromise()
        .then((res) => {
          resolve(res);
        })
  ...
  setPost(username: string, post: Post): Promise<Post> {
    return new Promise<Post>((resolve, reject) => {
      ...
      this.http.post<Post>('/api/posts', reqBody, this.httpOptions)
        .toPromise()
        .then((res) => {
          resolve(res);
        })
  ...
  deletePost(username: string, postid: number): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      this.http.delete<void>(`/api/posts?username=${username}&postid=${postid}`, this.httpOptions)
        .toPromise()
        .then(() => {
          resolve();
        })
